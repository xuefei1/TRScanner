 ...
 * @author eliasnaur
 */
public class TRService extends IntentService {

    private static final String SERVICE_NAME = TRService.class.getName();
    ...
    public static void startUpload(final UploadRequest task) throws IllegalArgumentException, MalformedURLException {
        ...
        if (task == null) {
            ...
            final Intent intent = new Intent(task.getContext(), TRService.class);
