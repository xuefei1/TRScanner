...
import trlabs.trscanner.trtabs.Favorite.FavoriteDatabaseHelper;
import trlabs.trscanner.trtabs.File.FileListItem.ModeCallback;
import trlabs.trscanner.trtabs.File.FileOperationHelper.IOperationProgressListener;
import trlabs.trscanner.trtabs.File.FileSortHelper.SortMethod;
import trlabs.trscanner.R;
import trlabs.trscanner.trtabs.FileViewActivity;
import trlabs.trscanner.trtabs.config.GlobalConsts;
import trlabs.trscanner.trtabs.IFileInteractionListener;
import trlabs.trscanner.trtabs.InformationDialog;
import trlabs.trscanner.trtabs.IntentBuilder;
import trlabs.trscanner.trtabs.config.Settings;
import trlabs.trscanner.trtabs.TRScannerTabActivity;
import trlabs.trscanner.trtabs.TextInputDialog;
...
public class FileViewInteractionHub implements IOperationProgressListener {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.button_operation_send:
                    onOperationSend();
                    break;
                case R.id.button_operation_profile:
                    onOperationDelete();
                    break;
                ...
                case R.id.path_pane_up_level:
                    onOperationUpLevel();
                    ActionMode mode = ((TRScannerTabActivity) mContext).getActionMode();
                    if (mode != null) {
                        mode.finish();
                    }
                    break;
    ...
    public void onOperationSelectAll() {
        ...
        TRScannerTabActivity fileExplorerTabActivity = (TRScannerTabActivity) mContext;
    ...
    private OnCreateContextMenuListener mListViewContextMenuListener = new OnCreateContextMenuListener() {
        ...
        public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
            ...
            addMenuItem(menu,GlobalConsts.MENU_NEW_FOLDER,0,R.string.new_folder_name);
        ...
        public boolean onMenuItemClick(MenuItem item) {
            ...
            switch (itemId) {
                ...
                case MENU_SETTING:
                    ...
                    break;
                case MENU_EXIT:
                    ((TRScannerTabActivity) mContext).finish();
                    break;
                // sort
                case MENU_SORT_NAME:
    ...
    private String getAbsoluteName(String path, String name) {
        return path.equals(GlobalConsts.ROOT_PATH) ? path + File.separator + name : path + File.separator + name;
    }
